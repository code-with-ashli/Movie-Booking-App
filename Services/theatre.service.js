...
class TheatreService {
    ...
    static async create(data) {
        const safeParsedData =
            await createTheaterValidationSchema.safeParseAsync(data)
    ...
    static async deleteByShowId(id) {
        return await TheatreHallMovieMapping.findByIdAndDelete(id)
    }
    ...
    static async createShow(data) {
        const validationResult =
            await createTheatreHallMovieMappingSchema.parseAsync(data)
    ...
    static getAllShowsByMovieId(data) {
        ...
        return TheatreHallMovieMapping.find(data).populate([
            {
                path: 'movieId', // Populates movie details (like title)
            },
            {
                path: 'theatreHallId',
               populate: [{ path: 'theatreId' }]
